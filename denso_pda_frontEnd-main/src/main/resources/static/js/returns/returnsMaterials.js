...
const returnsMaterials = function(){
	...
	let chargeDept = input.text('#chargeDept',true);
	let chargeUser = input.text('#chargeUser',true);
    ...
    const handleEvent = ()=>{
		...
		$('#btnSave').on('click', saveReturnsMaterials);
    }
