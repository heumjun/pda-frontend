...
const outputRegister = function(){
    ...
    const gridInit = () => {
        ...
        let columnsDefinition = [
            ...
            {binding:'st02Qr'	,header:'QR코드'	,width:150	,dataType:'String'	,align:'center'},
			{binding:'st02Qty'	,header:'투입수량'	,width:100	,dataType:'Number'	,editor:numberInput	,isRequired:true},
	...
	const bacodeSearch = async(bacode) => {
        ...
        try {
            let {partsInput} = await ajax.getAjax(params, true);  
